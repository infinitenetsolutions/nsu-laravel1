...
<head>
    ...
    <meta name="description"
        content="{{ $seo_data->description ?? 'Netaji Subhas University is the best University In jharkhand offerIng all courses with placement to shape your future and Inspire you to achieve great success In your dream career.' }}">
    ...
    <meta name="classification" content=" {{  $seo_data->classification ?? 'best university in jamshedpur, best university in jharkhand'}}" />
