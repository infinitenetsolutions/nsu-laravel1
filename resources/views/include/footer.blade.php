                ...
                <div class="modal-content">
                    <div id="ctl00_ContentPlaceHolder1_UpdatePanel2">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true" style="color:#e3ae21;border:3px solid #e3ae21;padding: 1px 6px;border-radius: 50%;line-height: 25px; opacity: 1;">&times;</span></button>
                        </div>
...
<div id="VirtualTour" class="w3-modal" style="z-index: 999999; display: none;">
    <div class="w3-modal-content w3-card-4 w3-animate-zoom" style="max-width:100%; margin-bottom:50px;">
        ...
        <div class="w3-container w3-border-top w3-padding-16" style="background-color:#1b4169;">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true" style="color:#fff;border:3px solid #fff;padding: 1px 6px;border-radius: 50%;line-height: 25px;">&times;</span></button>
        </div>
    </div>
</div>
<!-- // virtual tour -->
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-md-2 col-lg-2 col-xl-2 ftr-colm1">
                        ...
                        <ul class="icon-before">
                            ...
                            <li><a class="font-13" href="{{ route('about', $about->title) }}"><i class="fas fa-external-link-alt"></i>
                                    {{ $about->sub_title }}</a></li>

                            @endforeach
                            <li><a class="font-13" href="{{ route('govbody') }}"><i class="fas fa-external-link-alt"></i> The Governing Body</a></li>
                    ...
                    <div class="col-12 col-md-2 col-lg-2 col-xl-2 ftr-colm1">
                        ...
                        <ul class="icon-before">
                            ...
                            <li><a class="font-13 text-leftfgty` " href="{{ route('infrastructure', $infrastructure->title) }}">
            ...
            <div class="col-md-12 ">
                <div class="footer-section">
                    ...
                    <p class="footer-text">© 2022 <a href="">Netaji Subhas University.</a> All Rights Reserved ||
                        Developed With <i class="fa fa-heart" style="color:#c70013"></i> By <a href="http://infinitenetsolutions.com/" target="_blank">Infinite Net Solutions</a>
                    </p>
                </div>
            </div>
        </div>
